...
export default function NoDinnerIdeasCalories() {
  const faqs = [
    {
        ...
        <Container>
          ...
          <div className="mx-auto mt-12 max-w-3xl space-y-12">
            <ContentSection title="Why Dinner Feels Harder Than the Rest of the Day">
              ...
              <p>
                This is one of the most common moments where people abandon calorie awareness altogether. Not because of lack of motivation, but because <strong>decision fatigue at dinner is real</strong> — and when you&rsquo;re tired and hungry, &ldquo;figure out the math&rdquo; is the last thing you want to do.
              </p>
              <p>
            ...
            <ContentSection title='The "I Have Nothing in the Fridge" Problem'>
              ...
              <ul>
                ...
                <li><strong>Have 3 go-to &ldquo;emergency&rdquo; dinners memorized.</strong> Not meals you love the most — meals that are fast, reliable, and you know roughly how they fit your day. Eggs + vegetables, pasta with tomato sauce and protein, and a big salad with whatever&rsquo;s in the fridge.</li>
                <li><strong>Just describe it to Nuvvoo.</strong> Seriously — &ldquo;I&rsquo;m thinking eggs, some leftover rice, and whatever vegetables I have, what can I make and roughly how many calories is it?&rdquo; That&rsquo;s a real question an <Link href="/ai-food-journal">AI food companion</Link> can answer in seconds.</li>
              </ul>
            </ContentSection>
            ...
            <div className="my-12 flex flex-col items-center gap-4 text-center">
              ...
              <div className="flex gap-3">
                <TrackedButton
                  ...
                  eventParams={{ platform: 'ios', button_location: 'seo_dinner_ideas' }}
                ...
                <TrackedButton
                  ...
                  variant="outline"
                  eventName="click_platform"
                  eventParams={{ platform: 'android', button_location: 'seo_dinner_ideas' }}
