...
export default function PhotoVsChatCalorieTracking() {
  const faqs = [
    {
          ...
          <div className="mx-auto mt-12 max-w-3xl space-y-12">
            ...
            <ContentSection title="Where Chat Wins Over Photo">
              <ul>
                ...
                <li><strong>No photo = lower friction in real situations.</strong> Taking a photo of food at a restaurant table, at a work lunch, at a friend&rsquo;s dinner — there&rsquo;s a social awkwardness to it. Sending a quick description is invisible.</li>
              </ul>
            </ContentSection>

            <ContentSection title="Where Photo Wins Over Chat">
              <p>
                To be fair: for simple, whole foods — a piece of fruit, a protein bar, a packaged item with a barcode — photo recognition can be faster and accurate enough. If your diet is mostly single-ingredient whole foods, photo tracking may work well.
              </p>
              <p>
            ...
            <ContentSection title="The Bigger Picture">
              ...
              <p>
                <strong>Nuvvoo is built around the conversational approach.</strong> Describe your meals in plain language. Get estimates that account for what you actually used. Build awareness through reflection, not data entry. It&rsquo;s a <Link href="/alternative-to-myfitnesspal">different kind of alternative to traditional calorie apps</Link>.
              </p>
            </ContentSection>
